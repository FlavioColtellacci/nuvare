...
const features: Feature[] = [
  ...
  },
  {
    title: "Ask Anything",
    description:
      "Plain-language answers to complex cross-border questions, powered by Claude and live regulatory data. The 80% answer that tells you when you need a professional.",
    Icon: MessageSquare,
  },
  {
  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-black text-white">
      ...
      <section className="relative z-20 flex-1">
        <div className="absolute bottom-20 left-6 max-w-6xl md:bottom-24 md:left-10">
